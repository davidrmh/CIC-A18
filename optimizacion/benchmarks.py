...
def main():
    ...
    for obj in objetivos:
        ...
        for algoritmo in algoritmos:
            if algoritmo=='EP':
                mejor,valorMejor=EP(objetivo,500,70,limInf,limSup)
                f.write("##==============================================================##\n\n")
                ...
                mejor,valorMejor=EPVer2(objetivo,500,70,limInf,limSup)
                f.write("##==============================================================##\n\n")
                f.write("Para la funcion " + obj + "\n")
                f.write("Con el algoritmo " + algoritmo + '\n')
                f.write("Se obtiene un optimo en " + str(mejor) + '\n')
                ...
                mejor,valorMejor=DE(objetivo,500,70,limInf,limSup)
                f.write("##==============================================================##\n\n")
                f.write("Para la funcion " + obj + "\n")
                f.write("Con el algoritmo " + algoritmo + '\n')
                f.write("Se obtiene un optimo en " + str(mejor) + '\n')
